...
# Fetch the message prefix from the environment or use a default value
message_prefix = os.getenv("MESSAGE_PREFIX", "I just")
...
ADJECTIVES: list = ["amazing",  "incredible", "funny", "shocking", "mind-blowing"]
ACTIONS: list = ["discovered", "watched", "shared", "loved", "found"]
TOPICS: list = ["a movie", "a viral meme", "an app", "a gadget", "a book"]
...
def generate_custom_messages():
    ...
    while True:
        ...
        yield f"Breaking news! I just {action} {topic} and it was absolutely {adjective}!"
...
def main() -> None:
    ...
    for message in generate_custom_messages():
        logger.info(message)
